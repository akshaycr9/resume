              ...
              <div className="row">
                <div className="col-md-6">
                  ...
                  >
                    <a href="#web-development">
                      <figure className="cc-effect">
                        <img src="images/project-1.jpg" alt="project1" />
                        <figcaption>
                  ...
                  >
                    <a href="#web-development">
                      <figure className="cc-effect">
                        <img src="images/project-2.jpg" alt="project2" />
                        <figcaption>
                ...
                <div className="col-md-6">
                  ...
                  >
                    <a href="#web-development">
                      <figure className="cc-effect">
                        <img src="images/project-3.jpg" alt="project3" />
                        <figcaption>
                  ...
                  >
                    <a href="#web-development">
                      <figure className="cc-effect">
                        <img src="images/project-4.jpg" alt="project4" />
                        <figcaption>
              ...
              <div className="row">
                <div className="col-md-6">
                  ...
                  >
                    <a href="#graphic-design">
                      <figure className="cc-effect">
                        <img src="images/graphic-design-1.jpg" alt="design1" />
                        <figcaption>
                  ...
                  >
                    <a href="#graphic-design">
                      <figure className="cc-effect">
                        <img src="images/graphic-design-2.jpg" alt="design2" />
                        <figcaption>
                ...
                <div className="col-md-6">
                  ...
                  >
                    <a href="#graphic-design">
                      <figure className="cc-effect">
                        <img src="images/graphic-design-3.jpg" alt="design3" />
                        <figcaption>
                  ...
                  >
                    <a href="#graphic-design">
                      <figure className="cc-effect">
                        <img src="images/graphic-design-4.jpg" alt="design4" />
                        <figcaption>
